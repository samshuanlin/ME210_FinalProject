...
void driveNorth(void) {
  ...
  setMotorDirection(MOTOR_2_IN1_PIN, MOTOR_2_IN2_PIN, FORWARD_DIR);
  setMotorDirection(MOTOR_3_IN1_PIN, MOTOR_3_IN2_PIN, FORWARD_DIR);
  setMotorDirection(MOTOR_4_IN1_PIN, MOTOR_4_IN2_PIN, FORWARD_DIR);
}
...
void driveSouth(void) {
  setMotorDirection(MOTOR_1_IN1_PIN, MOTOR_1_IN2_PIN, BACKWARD_DIR);
  setMotorDirection(MOTOR_2_IN1_PIN, MOTOR_2_IN2_PIN, BACKWARD_DIR);
  setMotorDirection(MOTOR_3_IN1_PIN, MOTOR_3_IN2_PIN, BACKWARD_DIR);
  setMotorDirection(MOTOR_4_IN1_PIN, MOTOR_4_IN2_PIN, BACKWARD_DIR);
}
